...
<head>
    ...
    <meta name="description" content="Start your server with us today!">
    <meta name="keywords" content="vex panel, vex, panel, hosting, free, paid, fast">
    <meta name="author" content="Gallear Technologies">
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Login to <?php echo $siteName ?></h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="divider">
                                                <div class="divider-text">REMINDER</div>
                                            </div>
                                            <div class="footer-btn d-inline">
                                                <p>Please make sure that you are not on a VPN or Proxy service. If your on either of those, you will be instantly banned. Please contact a staff member for more information on this.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
