...
<head>
    ...
    <title>Vex Panel - Maintenance</title>
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="../../../app-assets/images/pages/maintenance-2.png" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-1">Under Maintenance!</h1>
                                    <p class="px-2">
                                        It seems we are under maintenance. Please contact support for more information.
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-1" href="/">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
