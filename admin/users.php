                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">See all of the users who are using your panel.</p>
...
if( $results->num_rows !== 0 ) {
   while($rowitem = mysqli_fetch_array($results)) {
    echo "<tr>";
    echo "<td>" . htmlspecialchars(base64_decode($rowitem['discord_usr'])) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['discord_id']) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['user_email']) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['coins']) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['minutes_idle']) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['ptero_uid']) . "</td>";
    echo "</tr>";
  }}else{
