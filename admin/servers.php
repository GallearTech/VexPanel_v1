    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active"><a href="./servers.php"><i class="fas fa-server"></i><span class="menu-item" data-i18n="Dashboard">Servers</span></a></li>
            </ul>
        </div>
    </div>
    <!-- END: Main Menu-->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Servers List</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <p class="card-text">See all of the servers that have been created.</p>
...
if( $results->num_rows !== 0 ) {
   while($rowitem = mysqli_fetch_array($results)) {
    ...
    echo "<td>" . htmlspecialchars($rowitem['server_ram']) . "</td>";
