        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/tables/basic-table.html">
              ...
              <span class="menu-title">Panel Info</span>
            </a>
          </li>
          <li class="nav-item menu-items">
        ...
        <div class="main-panel">
          ...
          <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Idle!</h4>
                    <p>For every minute you idle here, you get one coin. With those coins that you earn, you can purchase things from the shop. </p>
                    <p>You currently have <?php echo $coins ?> coin(s)!</p>
                    <p>You have been idling for <?php echo $mins_idle ?> minute(s)!</p>
